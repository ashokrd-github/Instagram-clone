...
class PostAdapter
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        Picasso.get().load(post.getPostImage()).placeholder(R.drawable.loading).into(holder.postImage)
//        val previous: LocalDate = Clock.System.todayIn(TimeZone.currentSystemDefault())
//        holder.time.text = previous.toJavaLocalDate().toString()
        holder.postTime.text = java.sql.Timestamp(post.timestamp).toString()
...
//        holder.Pshare.setOnClickListener {
//            val i = Intent(Intent.ACTION_SEND_MULTIPLE)
//            i.type = "text/plain"
//            i.putExtra(Intent.EXTRA_TEXT, post.getPostImage())
//
...
//        }
                ...
                holder.Pshare.setOnClickListener {
                    val imagePaths = post.getPostImage() // Assuming this returns List<String>
...
//                    }
                    ...
                    val i = Intent(Intent.ACTION_SEND_MULTIPLE)
                    i.type = "image/*" // Or "video/*", or "*/*" depending on file type
                    i.putParcelableArrayListExtra(Intent.EXTRA_STREAM, imageUris)
                    mContext.startActivity(Intent.createChooser(i, "Share Post Images"))//use createChooser.
                }
...
//
    ...
    inner class ViewHolder(@NonNull itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            ...
            Pshare = itemView.findViewById(R.id.Pshare)
        ...
        postRef.addValueEventListener(object : ValueEventListener {
            ...
            override fun onDataChange(datasnapshot: DataSnapshot) {
                if (datasnapshot.child(firebaseUser!!.uid).exists()) {
                    ...
                    imageView.setImageResource(R.drawable.unfilled_like)
                    postedImg.tag = "like"
                    imageView.tag = "like"
                }
            }
        ...
        savesRef.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                if (snapshot.child(postid).exists()) {
                    ...
                    imageView.setImageResource(R.drawable.save_two)
                    imageView.tag = "Save"
                }
            }
